...
#'              )
#'  StarrettTapDrills <- data.frame(Decimal, Numbers, tapSize, stringsAsFactors = FALSE)
#' }
#' @examples data(StarrettTapDrills)
#' str(StarrettTapDrills)
NULL
